# ---------------- BOT INTIMO COMPLETO ----------------
# (Versione con MENU FOTO 📸 + Surprise 😏 + Buongiorno/Buonanotte/Metà giornata potenziati)
...
# ---------------- MESSAGGI AUTOMATICI ----------------
# (AGGIORNATI SPICY/ROMANTICI/INTIMI)
...
GOOD_MORNING_LINES = [
    ...
    "Apri gli occhi… la tua ragazza è già sveglia e ti vuole 💛",
]
